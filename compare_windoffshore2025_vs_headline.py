...
wo2025 = load_de(rf"{ROOT}\Germany2027_MarketCoupling_ROEFlex_WindOffshore2025\result_Germany2027_MarketCoupling_ROEFlex_WindOffshore2025\DayAheadMarketMultiZone.csv")

print(f"{'Build':30s} {'mean':>8s} {'shortage':>9s} {'excl_r':>8s} {'excl_bias':>10s} {'excl_mae':>9s} {'neg%':>6s}")
for label, s in [("Headline (AMIRIS-2019 WO)", headline), ("WindOffshore2025", wo2025)]:
